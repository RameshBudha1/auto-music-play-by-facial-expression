...
# Set a custom favicon and page title
st.set_page_config(
    page_title="Music Recommender", 
    page_icon="./images/icon.png"  # or "path_to_your_favicon.png"
)
...
st.write('Music Recommender is emotion detection based music reccommendation system. To get reccommended songs, start by allowing mic and camera for this web app.')
...
if btn:
	if not(detected_emotion):
		...
		webbrowser.open(f"https://www.youtube.com/results?search_query={lang}+{detected_emotion}+songs")
		np.save("detected_emotion.npy", np.array([""]))
		st.session_state["run"] = "false"


st.write('Made with ❤ by [Mandu Group](https://github.com/nirmalkharal9)')
